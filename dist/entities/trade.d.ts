...
import { IRoute, RouteSDK } from "./route";
/**
 ...
 */
export declare function tradeComparator<TInput extends Currency, TOutput extends Currency, TTradeType extends TradeType>(a: TradeSDK<TInput, TOutput, TTradeType>, b: TradeSDK<TInput, TOutput, TTradeType>): number;
 ...
 * @template TTradeType The trade type, either exact input or exact output
 */
export declare class TradeSDK<TInput extends Currency, TOutput extends Currency, TTradeType extends TradeType> {
    /**
     ...
     */
    get route(): RouteSDK<TInput, TOutput>;
    /**
     ...
     */
    static exactIn<TInput extends Currency, TOutput extends Currency>(route: RouteSDK<TInput, TOutput>, amountIn: CurrencyAmount<TInput>): Promise<TradeSDK<TInput, TOutput, TradeType.EXACT_INPUT>>;
    /**
     ...
     */
    static exactOut<TInput extends Currency, TOutput extends Currency>(route: RouteSDK<TInput, TOutput>, amountOut: CurrencyAmount<TOutput>): Promise<TradeSDK<TInput, TOutput, TradeType.EXACT_OUTPUT>>;
    /**
     ...
     * @returns The route
     */
    static fromRoute<TInput extends Currency, TOutput extends Currency, TTradeType extends TradeType>(route: RouteSDK<TInput, TOutput>, amount: TTradeType extends TradeType.EXACT_INPUT ? CurrencyAmount<TInput> : CurrencyAmount<TOutput>, tradeType: TTradeType): Promise<TradeSDK<TInput, TOutput, TTradeType>>;
    /**
    ...
    static fromRoutes<TInput extends Currency, TOutput extends Currency, TTradeType extends TradeType>(routes: {
        ...
        route: RouteSDK<TInput, TOutput>;
    }[], tradeType: TTradeType): Promise<TradeSDK<TInput, TOutput, TTradeType>>;
    /**
...
export declare class Trade<TInput extends Currency, TOutput extends Currency, TTradeType extends TradeType> {
    ...
    static fromRoute<TInput extends Currency, TOutput extends Currency, TTradeType extends TradeType>(route: RouteSDK<TInput, TOutput>, amount: TTradeType extends TradeType.EXACT_INPUT ? CurrencyAmount<TInput> : CurrencyAmount<TOutput>, tradeType: TTradeType): Promise<Trade<TInput, TOutput, TTradeType>>;
}
